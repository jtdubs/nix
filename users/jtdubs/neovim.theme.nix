...
in
{
  xdg.configFile."nvim/colors/nix.vim".text = ''
    ...
    let s:nix0_gui = "#${palette.base00}"
    let s:nix1_gui = "#${palette.base01}"
    let s:nix2_gui = "#${palette.base02}"
    let s:nix3_gui = "#${palette.base03}"
    let s:nix3_gui_bright = "#${palette.base07}"
    let s:nix4_gui = "#${palette.base04}"
    let s:nix5_gui = "#${palette.base05}"
    let s:nix6_gui = "#${palette.base06}"
    let s:nix7_gui = "#${palette.base07}"
    let s:nix8_gui = "#${palette.base0C}"
    let s:nix9_gui = "#${palette.base0D}"
    let s:nix10_gui = "#${palette.base0F}"
    let s:nix11_gui = "#${palette.base08}"
    let s:nix12_gui = "#${palette.base09}"
    let s:nix13_gui = "#${palette.base0A}"
    let s:nix14_gui = "#${palette.base0B}"
    let s:nix15_gui = "#${palette.base0E}"
